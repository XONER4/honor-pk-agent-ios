...
struct ChatMessage: Identifiable, Codable, Equatable, Sendable {
    ...
    /// Поиск в интернете не смог открыть страницы, и ответ построен по знаниям
...
enum HonorError: LocalizedError {
    ...
    var errorDescription: String? {
        ...
        case .searchUnavailable: return "Поиск сейчас недоступен: страницы не открылись. Нажмите «Поиск», чтобы выключить его, — я отвечу по своим знаниям. Заодно я умею читать любые ваши чаты, открывать прикреплённые фото, видео и документы, вести таблицы и запоминать важное."
